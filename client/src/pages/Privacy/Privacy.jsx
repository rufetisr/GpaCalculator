...
const Privacy = () => {
    return (
        <div className='privacy' >
            ...
            <p>This Privacy Policy explains how the GPA Calculator ("we," "our," or "us") collects, uses, and protects your information when you use our service. By using the website, you agree to the terms outlined below.</p>
